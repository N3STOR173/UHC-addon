...
*/
//===============================================================================================================
function buildWall(size, height, startHeight, buildDist, axis, block, stableCord, variableCord) {
    ...
    */
    if (axis === "X") {
        for (let z = variableMin; z < variableMax + 1; z++) {
            if (((_a = dimension.getBlock({ x: stableCord, y: height - 1, z })) === null || _a === void 0 ? void 0 : _a.typeId) !== block) {
                for (let y = height - 1; y >= startHeight; y--) {
                    let blockAux = block;
                    if (((_b = dimension.getBlock({ x: stableCord, y, z })) === null || _b === void 0 ? void 0 : _b.typeId) !== "minecraft:air")
                        blockAux = "minecraft:bedrock";
                    (_c = dimension.getBlock({ x: stableCord, y, z })) === null || _c === void 0 ? void 0 : _c.setPermutation(BlockPermutation.resolve(blockAux));
                }
            }
        }
    }
        ...
        for (let x = variableMin; x < variableMax + 1; x++) {
            if (((_d = dimension.getBlock({ x, y: height - 1, z: stableCord })) === null || _d === void 0 ? void 0 : _d.typeId) !== block) {
                for (let y = height - 1; y >= startHeight; y--) {
                    let blockAux = block;
                    if (((_e = dimension.getBlock({ x, y, z: stableCord })) === null || _e === void 0 ? void 0 : _e.typeId) !== "minecraft:air")
                        blockAux = "minecraft:bedrock";
                    (_f = dimension.getBlock({ x, y, z: stableCord })) === null || _f === void 0 ? void 0 : _f.setPermutation(BlockPermutation.resolve(blockAux));
                }
            }
        }
    }
